...
class LessonPlanSeeder extends Seeder
{
    public function run(): void
    {
        ...
        LessonPlanOutcome::firstOrCreate([
        ...
        LessonPlanActivity::firstOrCreate([
            'lesson_plan_id' => $p1->id,
            'stage' => 'introduction',
        ], [
            'duration_minutes' => 5,
        ...
        LessonPlanReview::firstOrCreate([
            'lesson_plan_id' => $p1->id,
        ...
        LessonPlanStatusHistory::firstOrCreate([
            'lesson_plan_id' => $p1->id,
