...
class MessageTemplateController extends Controller
{
    ...
    public static function getDefaultTemplates(): array
    {
        return [
            ...
            [
                'id' => 'bangla_short',
                'name' => '৩. সংক্ষিপ্ত বাংলা এসএমএস (Short Bangla SMS)',
                'language' => 'bn',
                'category' => 'sms',
                'is_default' => false,
                'is_system' => true,
                'text' => "সম্মানিত {name} {salutation}, আপনার '{batchTitle}'-এর লেসন প্ল্যান এখনও জমা হয়নি। দয়া করে আজ রবিবারের মধ্যে পোর্টালে জমা দিন: {portalUrl} - BSISC",
            ],
            [
                'id' => 'english_formal',
            ...
            [
                'id' => 'urgent_tonight',
                'name' => '৫. জরুরি শেষ তাগিদ (Final Urgent Follow-up)',
                'language' => 'bn',
                'category' => 'whatsapp_sms',
                'is_default' => false,
                'is_system' => true,
